...
@Component({
  selector: 'app-tabero-jefe',
  templateUrl: './tabero-jefe.component.html',
  styleUrls: ['../../../estilos/angular-material.css'],
  providers: [ApiTareaOperacionService]
})
export class TaberoJefeComponent implements OnInit {
  ...
  ngOnInit() {
    this._api.GetTareaResponsable(this.usuarioModelo.ID).subscribe(response => {
      ...
      this.tareafinalizadarojo = this.tareaModelo.filter(c => c.ESTADO == 'COMPLETADA' && c.ALERTA_FINAL == 'VERDE');
